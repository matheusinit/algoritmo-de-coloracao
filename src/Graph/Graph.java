            ...
            for (int j = 0; j < matriz[i].length; j++) {
                ...
                for (Object aresta : listOfArestas) {
                    ...
                    if (arestaInType.getVerticeInicio() == vertice1 && arestaInType.getVerticeFim() == vertice2) {
                        return true;
                    } else if (arestaInType.getVerticeInicio() == vertice2
                            && arestaInType.getVerticeFim() == vertice1) {
                        return true;
                    }
                }
            }
            ...
            for (int j = 0; j < matriz[i].length; j++) {
                ...
                for (Object aresta : listOfArestas) {
                    ...
                    if (currentAresta.getDirecionado() && currentAresta.getVerticeInicio() == vertice
                            && !arestas.contains(currentAresta)) {
            ...
            for (int j = 0; j < matriz[i].length; j++) {
                ...
                for (Object aresta : listOfArestas) {
                    if (!arestaPrinted.contains((Aresta) aresta)) {
                        ...
                        System.out.println(((Aresta) aresta).getValue() + " " + vertice1.getElement() + " "
                                + vertice2.getElement() + " " + ((Aresta) aresta).getDirecionado());
                    }
                }
